...
#@test_throws ErrorException("Vectors must have same length") corkendall([1,2,3,4], [1,2,3]) # CHANGED!
...
#@test_throws ArgumentError corspearman([1 2; 3 4; 4 6], [1 2; 3 4]) CHANGED!!!

# TODO: fix corkendall to match corspearman (PR#659)
#@test_throws ErrorException corkendall([1], [1, 2]) CHANGED
#@test_throws ErrorException corkendall([1], [1 2; 3 4]) CHANGED
#@test_throws ErrorException corkendall([1 2; 3 4], [1]) CHANGED
#@test_throws ErrorException corkendall([1 2; 3 4; 4 6], [1 2; 3 4]) CHANGED
