...
res_3 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm); skipmissing=:pairwise)
res_4 = KendallTau.corkendall(xm; skipmissing=:listwise)
res_5 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm); skipmissing=:listwise)
res_6 = KendallTau.corkendall(xm; skipmissing=:none)
res_7 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm), skipmissing=:none)

res_8 = StatsBase.corkendall(x)
res_9 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm); skipmissing=:pairwise)
res_10 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm); skipmissing=:listwise)
res_11 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol(xm), skipmissing=:none)
...
res_14 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm); skipmissing=:pairwise)
res_15 = KendallTau.corspearman(xm; skipmissing=:listwise)
res_16 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm); skipmissing=:listwise)
res_17 = KendallTau.corspearman(xm; skipmissing=:none)
res_18 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm), skipmissing=:none)

res_19 = StatsBase.corspearman(x)
res_20 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm); skipmissing=:pairwise)
res_21 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm); skipmissing=:listwise)
res_22 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol(xm), skipmissing=:none)
...
print("KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm); skipmissing=:pairwise)   ")
@btime res_3 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm); skipmissing=:pairwise);
print("KendallTau.corkendall(\$xm; skipmissing=:listwise)                                            ")
@btime res_4 = KendallTau.corkendall($xm; skipmissing=:listwise);
print("KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm); skipmissing=:listwise)   ")
@btime res_5 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm); skipmissing=:listwise);
print("KendallTau.corkendall(\$xm; skipmissing=:none)                                                ")
@btime res_6 = KendallTau.corkendall($xm; skipmissing=:none);
print("KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm),skipmissing=:none)        ")
@btime res_7 = KendallTau.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm), skipmissing=:none);
if do_StatsBase_times
    print("StatsBase.corkendall(\$x)                                                                     ")
    @btime res_8 = StatsBase.corkendall($x)
    print("StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm); skipmissing=:pairwise)    ")
    @btime res_9 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm); skipmissing=:pairwise)
    print("StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm); skipmissing=:listwise)    ")
    @btime res_10 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm); skipmissing=:listwise)
    print("StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(\$xm),skipmissing=:none)         ")
    @btime res_11 = StatsBase.pairwise(KendallTau.corkendall, KendallTau._eachcol($xm), skipmissing=:none)
end
...
print("KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm); skipmissing=:pairwise)  ")
@btime res_14 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm); skipmissing=:pairwise);
print("KendallTau.corspearman(\$xm; skipmissing=:listwise)                                           ")
@btime res_15 = KendallTau.corspearman($xm; skipmissing=:listwise);
print("KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm); skipmissing=:listwise)  ")
@btime res_16 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm); skipmissing=:listwise);
print("KendallTau.corspearman(\$xm; skipmissing=:none)                                               ")
@btime res_17 = KendallTau.corspearman($xm; skipmissing=:none);
print("KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm),skipmissing=:none)       ")
@btime res_18 = KendallTau.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm), skipmissing=:none);
if do_StatsBase_times
    print("StatsBase.corspearman(\$x)                                                                    ")
    @btime res_19 = StatsBase.corspearman($x)
    print("StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm); skipmissing=:pairwise)   ")
    @btime res_20 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm); skipmissing=:pairwise)
    print("StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm); skipmissing=:listwise)   ")
    @btime res_21 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm); skipmissing=:listwise)
    print("StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(\$xm),skipmissing=:none)        ")
    @btime res_22 = StatsBase.pairwise(KendallTau.corspearman, KendallTau._eachcol($xm), skipmissing=:none)
end
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   1.214969 seconds (1.41 k allocations: 16.225 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.004514 seconds (371 allocations: 16.281 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.005616 seconds (3.41 k allocations: 11.926 MiB, 0.01% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.085907 seconds (1.37 k allocations: 17.175 MiB, 46.68% gc time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.046944 seconds (2.30 k allocations: 17.238 MiB, 0.66% compilation time)
StatsBase.corkendall(x)                                                        17.903242 seconds (3.00 M allocations: 17.090 GiB, 3.50% gc time)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   78.405344 seconds (13.99 M allocations: 77.959 GiB, 3.32% gc time)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)    0.010718 seconds (1.01 k allocations: 11.796 MiB)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        26.432848 seconds (8.99 M allocations: 65.922 GiB, 7.83% gc time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  0.360532 seconds (4.62 k allocations: 54.358 MiB, 11.29% gc time, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.002868 seconds (8 allocations: 16.213 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.006821 seconds (5.62 k allocations: 12.073 MiB, 0.02% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.581993 seconds (4.00 M allocations: 169.628 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.133535 seconds (4.63 k allocations: 55.313 MiB, 34.60% gc time, 0.00% compilation time)
StatsBase.corspearman(x)                                                       13.476731 seconds (3.50 M allocations: 11.441 GiB, 3.17% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  65.062766 seconds (18.00 M allocations: 108.969 GiB, 5.62% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)   0.418071 seconds (11.00 M allocations: 683.182 MiB, 15.70% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       55.576783 seconds (13.00 M allocations: 99.632 GiB, 5.75% gc time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   1.244402 seconds (1.41 k allocations: 16.225 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.005517 seconds (2.41 k allocations: 11.857 MiB, 0.02% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.054398 seconds (2.30 k allocations: 17.238 MiB, 0.51% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.044981 seconds (1.42 k allocations: 17.179 MiB, 0.00% compilation time)
StatsBase.corkendall(x)                                                        19.696329 seconds (3.00 M allocations: 17.090 GiB, 4.60% gc time)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   80.622690 seconds (13.99 M allocations: 77.959 GiB, 3.36% gc time)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)    0.012313 seconds (1.01 k allocations: 11.796 MiB)
StatsBase.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        26.501152 seconds (8.99 M allocations: 65.922 GiB, 7.48% gc time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  0.374690 seconds (3.36 M allocations: 137.098 MiB, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.003979 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.004783 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       8.639080 seconds (4.00 M allocations: 178.427 MiB, 0.24% gc time, 0.00% compilation time)
StatsBase.corspearman(x)                                                       13.868207 seconds (3.50 M allocations: 11.441 GiB, 2.88% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  64.612480 seconds (18.00 M allocations: 108.969 GiB, 5.31% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)   0.430488 seconds (11.00 M allocations: 683.182 MiB, 14.16% gc time)
StatsBase.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       53.680572 seconds (13.00 M allocations: 99.632 GiB, 5.70% gc time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   1.234423 seconds (1.41 k allocations: 16.225 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.006139 seconds (2.41 k allocations: 11.857 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.005733 seconds (2.41 k allocations: 11.857 MiB, 0.01% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.046176 seconds (1.42 k allocations: 17.179 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.046081 seconds (1.42 k allocations: 17.179 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  0.368137 seconds (3.36 M allocations: 137.098 MiB, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.004652 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.005132 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.024284 seconds (3.22 k allocations: 17.408 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.023459 seconds (3.22 k allocations: 17.408 MiB, 0.00% compilation time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   0.222159 seconds (163 allocations: 893.031 KiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.001032 seconds (264 allocations: 517.547 KiB, 0.10% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.001300 seconds (265 allocations: 517.578 KiB, 0.09% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.013528 seconds (173 allocations: 903.250 KiB, 0.02% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.012328 seconds (174 allocations: 903.281 KiB, 0.01% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  0.065485 seconds (175 allocations: 1.648 MiB, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.000458 seconds (383 allocations: 623.266 KiB, 0.22% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.000441 seconds (384 allocations: 623.297 KiB, 0.18% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.006470 seconds (295 allocations: 1.125 MiB, 0.02% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.005401 seconds (291 allocations: 985.828 KiB, 0.02% compilation time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   5.935599 seconds (1.19 k allocations: 15.511 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.024470 seconds (2.19 k allocations: 11.817 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.030347 seconds (2.19 k allocations: 11.817 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.293400 seconds (1.20 k allocations: 16.465 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.332153 seconds (1.20 k allocations: 16.465 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  2.265923 seconds (1.26 k allocations: 23.187 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.008436 seconds (2.11 k allocations: 19.428 MiB, 0.02% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.075054 seconds (3.13 k allocations: 33.516 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.066340 seconds (3.13 k allocations: 17.304 MiB, 0.00% compilation time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   7.760810 seconds (1.19 k allocations: 15.511 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.015878 seconds (2.19 k allocations: 11.817 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.015381 seconds (2.19 k allocations: 11.817 MiB, 0.01% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.349647 seconds (1.20 k allocations: 16.465 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.357957 seconds (1.20 k allocations: 16.465 MiB, 2.42% gc time, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  2.560398 seconds (1.26 k allocations: 23.187 MiB, 2.04% gc time, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.008440 seconds (2.11 k allocations: 19.428 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.007319 seconds (2.11 k allocations: 19.428 MiB, 0.02% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.042035 seconds (1.62 k allocations: 17.271 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.140749 seconds (1.62 k allocations: 17.271 MiB, 76.24% gc time, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   5.151125 seconds (1.19 k allocations: 15.511 MiB, 0.00% compilation time)
KendallTau.corkendall(xm; skipmissing=:listwise)                                0.017559 seconds (2.19 k allocations: 11.817 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.029807 seconds (2.19 k allocations: 11.817 MiB, 38.21% gc time, 0.01% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.217566 seconds (2.08 k allocations: 16.524 MiB, 0.33% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.214024 seconds (1.21 k allocations: 16.465 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  1.514433 seconds (1.26 k allocations: 23.187 MiB, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.011910 seconds (2.11 k allocations: 19.428 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.010740 seconds (2.11 k allocations: 19.428 MiB, 0.08% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.040009 seconds (1.62 k allocations: 17.271 MiB, 0.00% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.034767 seconds (1.63 k allocations: 17.271 MiB, 0.00% compilation time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:pairwise)   1.224037 seconds (1.41 k allocations: 16.232 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm); skipmissing=:listwise)   0.006864 seconds (2.41 k allocations: 11.857 MiB, 0.01% compilation time)
KendallTau.corkendall(xm; skipmissing=:none)                                    0.049554 seconds (2.30 k allocations: 17.245 MiB, 0.55% compilation time)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol(xm),skipmissing=:none)        0.046614 seconds (1.42 k allocations: 17.187 MiB, 0.00% compilation time)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:pairwise)  0.315540 seconds (1.57 k allocations: 23.977 MiB, 0.00% compilation time)
KendallTau.corspearman(xm; skipmissing=:listwise)                               0.005178 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm); skipmissing=:listwise)  0.007253 seconds (2.21 k allocations: 19.440 MiB, 0.02% compilation time)
KendallTau.corspearman(xm; skipmissing=:none)                                   0.017099 seconds (1.72 k allocations: 17.376 MiB, 0.01% compilation time)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol(xm),skipmissing=:none)       0.019922 seconds (1.72 k allocations: 17.376 MiB, 0.01% compilation time)
====================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:pairwise)   5.386 s (1161 allocations: 15.51 MiB)
KendallTau.corkendall($xm; skipmissing=:listwise)                                10.623 ms (2194 allocations: 11.82 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:listwise)   9.813 ms (2162 allocations: 11.82 MiB)
KendallTau.corkendall($xm; skipmissing=:none)                                    204.811 ms (1204 allocations: 16.47 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm),skipmissing=:none)        209.378 ms (1202 allocations: 16.47 MiB)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:pairwise)  2.103 s (1228 allocations: 23.18 MiB)
KendallTau.corspearman($xm; skipmissing=:listwise)                               4.615 ms (2113 allocations: 19.43 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:listwise)  4.637 ms (2081 allocations: 19.43 MiB)
KendallTau.corspearman($xm; skipmissing=:none)                                   21.871 ms (1625 allocations: 17.27 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm),skipmissing=:none)       22.049 ms (1623 allocations: 17.27 MiB)
========================================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:pairwise)   1.577 s (1377 allocations: 16.23 MiB)
KendallTau.corkendall($xm; skipmissing=:listwise)                                5.748 ms (2410 allocations: 11.86 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:listwise)   5.196 ms (2378 allocations: 11.85 MiB)
KendallTau.corkendall($xm; skipmissing=:none)                                    53.383 ms (1420 allocations: 17.19 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm),skipmissing=:none)        52.164 ms (1418 allocations: 17.19 MiB)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:pairwise)  405.928 ms (1540 allocations: 23.98 MiB)
KendallTau.corspearman($xm; skipmissing=:listwise)                               2.944 ms (2209 allocations: 19.44 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:listwise)  2.966 ms (2177 allocations: 19.44 MiB)
KendallTau.corspearman($xm; skipmissing=:none)                                   13.384 ms (1721 allocations: 17.38 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm),skipmissing=:none)       13.110 ms (1719 allocations: 17.38 MiB)
========================================================================================================================
...
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:pairwise)   1.445 s (1297 allocations: 16.19 MiB)
KendallTau.corkendall($xm; skipmissing=:listwise)                                5.546 ms (2330 allocations: 11.82 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm); skipmissing=:listwise)   5.505 ms (2298 allocations: 11.82 MiB)
KendallTau.corkendall($xm; skipmissing=:none)                                    51.045 ms (1340 allocations: 17.15 MiB)
KendallTau.pairwise(KendallTau.corkendall,KendallTau._eachcol($xm),skipmissing=:none)        54.172 ms (1338 allocations: 17.15 MiB)
...
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:pairwise)  408.834 ms (1460 allocations: 23.94 MiB)
KendallTau.corspearman($xm; skipmissing=:listwise)                               3.235 ms (2209 allocations: 19.44 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm); skipmissing=:listwise)  2.911 ms (2177 allocations: 19.44 MiB)
KendallTau.corspearman($xm; skipmissing=:none)                                   13.804 ms (1721 allocations: 17.38 MiB)
KendallTau.pairwise(KendallTau.corspearman,KendallTau._eachcol($xm),skipmissing=:none)       13.510 ms (1719 allocations: 17.38 MiB)
========================================================================================================================
