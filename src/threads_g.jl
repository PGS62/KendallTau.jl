...
function corkendall_threads_g(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
...
function corkendall_threads_v7(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
    C = Matrix{Float64}(I, n, n)
...
function corkendall_threads_v8(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
    C = Matrix{Float64}(I, n, n)
...
function corkendall_threads_v9(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
    C = Matrix{Float64}(I, n, n)
...
function corkendall_threads_v10(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
    C = Matrix{Float64}(I, n, n)
...
function corkendall_threads_v6(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
    C = Matrix{Float64}(I, n, n)
    for j = 2:n
