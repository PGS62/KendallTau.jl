...
function corkendallthreads_v2(x::Union{RealVector,RealOrMissingVector}, Y::Union{RealMatrix,RealOrMissingMatrix})
    n = size(Y, 2)
...
function corkendallthreads_v2(X::Union{RealMatrix,RealOrMissingMatrix})
    n = size(X, 2)
